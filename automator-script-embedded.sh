...
# Set up terminal environment for Automator
...
tell application "Terminal"
    ...
    do script "
        ...
        echo \"==================================\"
        echo \"Self-contained version - no external files needed\"
        echo \"\"
        
        # Embedded Panini Everest Engine Management Script
        ...
        start_service() {
            ...
            sudo launchctl unload /Library/LaunchDaemons/com.panini.everestengine.plist 2>/dev/null
            sleep 2
            
            # Start the service
            echo \"Loading Panini LaunchDaemon...\"
            debug_log \"Attempting to load: /Library/LaunchDaemons/com.panini.everestengine.plist\"
            sudo launchctl load /Library/LaunchDaemons/com.panini.everestengine.plist
        ...
        stop_service() {
            ...
            if [ -n \"\$mono_pids\" ]; then
                ...
                sudo kill -9 \$mono_pids 2>/dev/null
                killed_any=true
            fi
            ...
            if [ -n \"\$panini_pids\" ]; then
                ...
                sudo kill -9 \$panini_pids 2>/dev/null
                killed_any=true
            fi
            ...
            if [ -n \"\$port_pids\" ]; then
                ...
                sudo kill -9 \$port_pids 2>/dev/null
                killed_any=true
            fi
...
# Embedded Panini Everest Engine Management Script
# This is the complete script embedded directly in the Automator app
